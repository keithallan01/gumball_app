        ...
        <tr key={customer.id}>
          ...
          <td>
            <button
              ...
              onClick={this.handleEditCustomer.bind(
                this,
                customer.id,
                customer.firstName,
                customer.lastName,
          ...
          <td>
            <button
              ...
              onClick={this.handleDeleteCustomer.bind(this, customer.id)}
            >
              Delete
            </button>
          </td>
      ...
      <div className="customer-info container">
        ...
        >
          ...
          <ModalBody>
            <FormGroup>
              ...
              <Input
                type="text"
                id="ferstName"
                defaultValue={this.state.newCustomerInfo.firstName}
              ...
              <Input
                type="text"
                id="lastName"
                defaultValue={this.state.newCustomerInfo.lastName}
              ...
              <Input
                type="textarea"
                id="address"
                defaultValue={this.state.newCustomerInfo.address}
              ...
              <Input
                id="town"
                defaultValue={this.state.newCustomerInfo.town}
              ...
              <Input
                type="text"
                id="emailAddress"
                defaultValue={this.state.newCustomerInfo.emailAddress}
              ...
              <Input
                type="text"
                id="telephoneNumber"
                defaultValue={this.state.newCustomerInfo.telephoneNumber}
          ...
          <ModalFooter>
            ...
            <Button color="secondary" onClick={this.handleOnClickNewCustomer}>
              Cancel
            </Button>
          </ModalFooter>
        </Modal>
        ...
        >
          ...
          <ModalBody>
            <FormGroup>
              ...
              <Input
                type="text"
                id="ferstName"
                defaultValue={this.state.editCustomerInfo.firstName}
                onChange={this.handleFirstNameChange}
              />
              ...
              <Input
                type="text"
                id="lastName"
                defaultValue={this.state.editCustomerInfo.lastName}
                onChange={this.handleLastNameChange}
              />
              ...
              <Input
                type="textarea"
                id="address"
                defaultValue={this.state.editCustomerInfo.address}
                onChange={this.handleAddressChange}
              />
              ...
              <Input
                id="town"
                defaultValue={this.state.editCustomerInfo.town}
                onChange={this.handleTownChange}
              />
              ...
              <Input
                type="text"
                id="emailAddress"
                defaultValue={this.state.editCustomerInfo.emailAddress}
                onChange={this.handleEmailAddressChange}
              />
              ...
              <Input
                type="text"
                id="telephoneNumber"
                defaultValue={this.state.editCustomerInfo.telephoneNumber}
                onChange={this.handleTelephoneNumberChange}
              />
            </FormGroup>
          </ModalBody>
          <ModalFooter>
            ...
            <Button color="secondary" onClick={this.handleOnClickEditCustomer}>
              Cancel
            </Button>
          </ModalFooter>
        </Modal>
